...
public class SmilesDepictor {
	...
	public static void main(String[] args) throws Exception {
		...
		while (line != null) {
			...
			DepictionGenerator dptgen = new DepictionGenerator().withSize(300, 300)
			...
			ImageIO.write(image, "png",
					new File("Isomeric_CHEMBL_IMAGES/" + splitted_line[0] + ".png"));

			bufferWriter.write("Isomeric_CHEMBL_IMAGES/"+splitted_line[0] + "," + splitted_line[1] + "\n");
		}
			 catch(Exception e) { 
			 	System.out.println("toString(): "  + e.toString());
			 	bufferWriter.write(splitted_line[0]+"rejected\n");
			 }
