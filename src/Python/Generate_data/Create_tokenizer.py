...
def main():
	...
	Smiles_Path = "DECIMER_Isomeric_data_final_Inchi"
	...
	with open("tokenizer_Isomeric_Inchi.pkl","wb") as file:
		pickle.dump(tokenizer,file)

	with open("max_length_Isomeric_Inchi.pkl","wb") as file:
...
def data_loader(Smiles_Path):
	...
	for line in smiles.split('\n'):
		...
		image_id = 'Isomeric_CHEMBL_IMAGES/'+str(tokens[0])+'.png'
		#Add start and end annotations to SMILES string 
		try:
			SMILES_ = '<start> ' + str(tokens[1].rstrip()) + ' <end>'
	...
	img_name_train, cap_train, img_name_val, cap_val = img_name_vector[0:1536000],cap_vector[0:1536000],img_name_vector[1536000:2422754],cap_vector[1536000:2422754]
